...
const FeaturesGrid = () => {
    ...
    const secondHemisphereRotate = useTransform(secondHemisphereScrollYProgress,[0,1],[-20,20])
            ...
            <div className="flex flex-col gap-56 md:gap-48 lg:gap-80">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="col-span-2">
                        ...
                        <p className="text-xl text-zinc-400 mt-8 lg:text-2xl">Blockforge provides robust and secure infrastructure to support the next generation application. </p>
                        <ul className="flex flex-col gap-8 mt-12">
                            {listItems.map((item)=>(
                                <li key={item} className="flex items-center gap-3">
                                    <div className="inline-flex flex-shrink-0 justify-center items-center size-8 outline outline-4 outline-fuchsia-500 rounded-full -outline-offset-4 "> 
                        ...
                        <div className="flex gap-8 mt-12">
                            ...
                            <TextButtton>Learn More</TextButtton>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="col-span-2">
                        ...
                        <div className="flex flex-col gap-6 text-xl text-zinc-400 mt-6 lg:text-2xl">
                            <p >Blockforge is  dedicated to supporting the evolution of Web3 appliaction by  delivering the necessary infrastructure and security for Web3.</p>
                            <p>Blockforge champions Web3 for everone. As a decentralized blockchain scaling platform, Blockforge enables developers to create scalable, user-firendly dApps with low transaction costs, all while ensuring robust security.</p>
                        </div> 
                        <div className="flex gap-8 mt-12">
                            <CutCornerButton>Get Started</CutCornerButton>
                            <TextButtton>Learn More</TextButtton>
